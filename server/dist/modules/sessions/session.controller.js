...
let SessionController = class SessionController extends base_controller_1.BaseController {
    ...
    getSessions(body) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = this.tryExecute(() => __awaiter(this, void 0, void 0, function* () {
                const sessions = yield this.sessionService.getSessions(body);
    ...
    addSession(body) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = this.tryExecute(() => __awaiter(this, void 0, void 0, function* () {
                yield this.sessionService.addSession(body);
            }));
            return result;
        });
    }
...
SessionController = __decorate([
    (0, inversify_express_utils_1.controller)('/session', config_1.InjectionTokens.tokenValidationMiddleware),
    __param(0, (0, inversify_1.inject)(config_1.InjectionTokens.log)),
    __param(1, (0, inversify_1.inject)(config_1.InjectionTokens.sessionService))
], SessionController);
